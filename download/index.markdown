...
author: Gabriel Burt
comments: false
date: 2008-06-06 19:14:41+00:00
layout: page
slug: download
title: Download
show-sidebar: true
...
* **openSUSE Tumbleweed:** [1-Click Install](http://download.banshee.fm/banshee/ymp?Tumbleweed) | [Repository](http://download.opensuse.org/repositories/Banshee/Tumbleweed/)


* **openSUSE Factory:** [1-Click Install](http://download.banshee.fm/banshee/ymp?Factory) | [Repository](http://download.opensuse.org/repositories/Banshee/Factory/)
...
Banshee is a default app on Ubuntu 11.04 and 11.10. Ubuntu has a policy of not updating the version of a shipped application, so the version available in the default repository might be old. Note that Canonical modifies our code to take a 75% cut of our Amazon affiliate revenue.  If you use Banshee from the community PPA below, 100% of the affiliate revenue will go to GNOME.


To add the community-run [Banshee Team PPA](https://launchpad.net/~banshee-team/+archive):
...
Banshee for OS X runs on Intel 10.7 (Lion) and 10.8 (Mountain Lion). _OS X 10.6 and older and the PowerPC architecture are not supported._
...
### Beta Releases
  ...
  * [SUSE](http://download.opensuse.org/repositories/Banshee:/Unstable/)


  * [Ubuntu](https://launchpad.net/~banshee-team/+archive/banshee-unstable)
...
### Snapshot/Alpha Releases
  ...
  * [Ubuntu](https://launchpad.net/~banshee-team/+archive/banshee-daily)
...
See [getting the development version](/download/development) for more information.
