...
author: Bertrand
comments: false
date: 2012-03-08 02:05:53+00:00
layout: page
slug: 2-3-6
title: Banshee 2.3.6
wordpress_id: 1188
---
  ...
  * **Source Tarball:** [banshee-2.3.6.tar.xz](http://ftp.gnome.org/pub/GNOME/sources/banshee/2.3/banshee-2.3.6.tar.xz)

	
  * **Release Information:**
[NEWS](http://ftp.gnome.org/pub/GNOME/sources/banshee/2.3/banshee-2.3.6.news),
[sha256sum](http://ftp.gnome.org/pub/GNOME/sources/banshee/2.3/banshee-2.3.6.sha256sum)
...
### Notable Bug Fixes (4 fixed since 2.3.5)
...
> 
     Andre Klapper, Andres G. Aragoneses, Bertrand Lorentz, Neil Loknath,
     Phil Trimble
...
> 
     Benjamín Valero, Fran Diéguez, Kristjan SCHMIDT, Marek ?ernocký,
     Mario Blättermann, Matej Urban?i?, ???????? ???????
